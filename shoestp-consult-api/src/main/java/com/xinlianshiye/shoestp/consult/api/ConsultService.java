package com.xinlianshiye.shoestp.consult.api;
...
public interface ConsultService {
  ...
  /**
   * 我的询盘(包括RFQ) 搜索条件 关键字, 未读, 询盘类型(询盘, RFQ, 私人展厅询盘等)
   *
   * @throws IOException
   * @author Jianhua Ying
   */
  Page<RFQConsultView> pageMine(Purchase purchase, Byte t, String keyword, Boolean unread, Integer lastRelation, Integer start, Integer limit);
   ...
   * @return
   * @throws IOException
   * @author zjl @Date 2019/2/27 16:10
   */
